...
# Summary
The code seems to be readable for the most part. It is not too difficult to understand what the functions do since it incorporates commments with explanations and examples. For example, the annotate reporter in the annotate.py file explains what the class is and provides and example of how it is used. Comments with explanations are written for many functions and tests throughout the whole program which is really helpful. I think updating/maintaining this code wouldn't be too bad if I looked deeper into the code to understand its syntax. The code seems much more organized and simplified compared to something I would write. There are separate folders containing major operations like coverage and tests.  However I do find a lot of things to be imported that I don't exactly know about. Although there are quite a lot of syntax I am unsure about, the overall format of the code seems understandable. 
